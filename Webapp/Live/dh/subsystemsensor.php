    ...
    <head>
		...
		<script type="text/javascript">
			...
			$(document).ready( function(){
				$('#wrapper').load('<?php echo('php/getsubsystemsensors.php'); ?>');
				$('#rightpanel').load('<?php echo('php/getpanels.php');?>');
				$('#leftpanel').load('<?php echo('php/getsubsystemactuators.php'); ?>', function(){
					$(this).trigger('create');
				});			
				refresh();
			});
			...
			{
				setTimeout( function() {
				$('#wrapper').load('<?php echo('php/getsubsystemsensors.php?id'); ?>');
				$('#leftpanel').load('<?php echo('php/getsubsystemactuators.php'); ?>', function(){
					$(this).trigger('create');
				});
				refresh();
