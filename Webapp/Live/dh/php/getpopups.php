...
$dataPopup = mysqli_query($db,"SELECT a.id, b.cwhy, b.cwhat, b.cwhen FROM vwdashboardsensorshomepage a, tbpopup b WHERE a.id = b.tbSensor_id AND tbnode_id = " . $_SESSION["id"]) 
  or die(mysqli_error()); 
