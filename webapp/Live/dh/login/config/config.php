 ...
 */
define("DB_HOST", "192.168.178.33");
define("DB_NAME", "dhx");
define("DB_USER", "dhuser");
define("DB_PASS", "dkl&%8&=ì23ì01918hsts2gs7825af12zzq5!}ãªÉ");
 ...
 */
define("COOKIE_RUNTIME", 12096000);
define("COOKIE_DOMAIN", ".casadinamica.dlinkddns.com");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "xxxxxx@gmail.com");
define("EMAIL_SMTP_PASSWORD", "xxxxxxx");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://casadinamica.ddns.net:90/dh/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "CasaDinamica");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for CasaDinamica");
 ...
 */
define("EMAIL_VERIFICATION_URL", "xxxhttp://casadinamica.ddns.net:90/domotichome/dashboardJQ/login/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "CasaDinamica");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for CasaDinamica");
